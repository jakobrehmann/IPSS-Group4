...
begin
    net = initializeNetwork(; n_nodes = n_nodes, network_structure = "grid")
    model = initialize(net;
    seed=3987623409,
    n_nodes=n_nodes,
    base_susceptibility=0.9,
    recovery_rate = 0.1,
    hom_het="homogenous",
    local_global_weight = 1
    )
...
# figs, abmobs = abmexploration(model; agent_step!, as = 25)
# figs

# model = initialize(;hom_het = "homogenous")
